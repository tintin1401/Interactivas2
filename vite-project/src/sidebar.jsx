...
export function Sidebar(){
    return(
        <aside className='w-64 bg-blue-900 text-white hidden md:block fixed inset-y-0 z-50 lg:static' id="sidebar">
          ...
          <nav className='m-10'>
            <ul className='text-lg'>
              ...
              <li><a href="#" className='flex py-5 px-4'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className='w-6 h-6 mr-4'>
            ...
            <nav class="m-10">
                <a href="#" class="flex py-5 px-4 text-lg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-4">
