      ...
      <aside className={`w-64 bg-blue-900 text-white ${sidebarToggle? '' : 'hidden'} sd:block fixed inset-y-0 z-50 ff-main`}>
        ...
        <nav className='m-10'>
          <ul className='text-lg'>
            ...
            <li><NavLink to="/home" className='flex py-5 px-4'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className='w-6 h-6 mr-4'>
          ...
          <nav className="mx-10 mb-10 mt-20 border-t-2 border-t-stone-50">
              <button onClick={handleLogout} className="flex py-5 px-4 text-lg w-full text-left"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-4">
